...
public class AjaxService {
	...
	private final String serviceKey = "6KknNi1%2FVVor0lE%2BNkayvlM9arGgKYaX%2FRSxuWw9VBOdQctE9kIoBw38TL1ncQm0jf9B2F380TdvwchWAIPi3g%3D%3D";
	...
	public String getMidFcst()throws IOException {
		...
		if(conn.getResponseCode() == 200) {				// 응답이 200 OK 이면
			...
			while(sc.hasNextLine()) {		// 다음줄이있다면
				data += sc.nextLine();		// 다음줄을 data에 더한다
			}
