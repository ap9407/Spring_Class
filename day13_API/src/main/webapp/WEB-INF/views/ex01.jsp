...
<script>
	...
	// 어제의 경우)
	// 자바스크립트가 실행되는 문서의 주소는 http://localhost:8080/day12/
	// 자원을 제공하는 서버의 주소 또한 	 http://localhost:8080/day12/homeplus/dataList
	const url ='https://apis.data.go.kr/6260000/AttractionService/getAttractionKr?serviceKey=6KknNi1%2FVVor0lE%2BNkayvlM9arGgKYaX%2FRSxuWw9VBOdQctE9kIoBw38TL1ncQm0jf9B2F380TdvwchWAIPi3g%3D%3D&pageNo=1&numOfRows=10&resultType=json'
	fetch(url)
	.then(resp => resp.json())
	.then(json =>{
...
//			const imgThumb = item.querySelector('.MAIN_IMG_THUMB')
			
			// 자바스크립트에서 css 속성에 접근할때, -로 연결되는 이름은 camelCase 로 바꿔서 접근해야 한다.
